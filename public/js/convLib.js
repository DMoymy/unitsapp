...
if(bmi<16){
  ...
  conc.innerHTML = "<i><b>Conclusion</b><P style='text-align:left;'>Based on your BMI, You are highly underweight.</P></i>";
  ...
  conc.innerHTML = "<i><b>Conclusion</b><P style='text-align:left;'>Based on your BMI, You are underweight.</P></i>";
  ...
  conc.innerHTML = "<i><b>Conclusion</b><P style='text-align:left;'>Based on your BMI, your weight is normal.</P></i>";
  ...
  conc.style.backgroundColor = "yellow";
  conc.style.color = "darkBlue";
  conc.innerHTML = "<i><b>Conclusion</b><P style='text-align:left;'>Based on your BMI, You are overweight.</P></i>";
  ...
  conc.style.backgroundColor = "red";
  conc.style.color = "cyan";
  conc.innerHTML = "<i><b>Conclusion</b><P style='text-align:left;'>Based on your BMI, You are highly overweight (obese).</P></i>";
...
abapp += '<p>&nbsp;&nbsp;Units Converter is an interactive and user friendly Progressive Web Application that allows you to convert temperature, length and weight units of measurement from one metric system to another.<br> It also provides you with a Body Mass Index calculator for checking your weight.</p></section>';
